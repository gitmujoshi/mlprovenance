...
def parse_args():
    ...
    parser.add_argument('--model-name', type=str, default='gpt2', help='Name of the GPT-2 model to use')
    parser.add_argument('--output-dir', type=str, default='artifacts/provenance', help='Directory to save provenance and safety reports')
    parser.add_argument('--epochs', type=int, default=3, help='Number of training epochs')
    parser.add_argument('--batch-size', type=int, default=32, help='Training batch size')
    parser.add_argument('--min-age-rating', type=str, default='TEEN', choices=['ALL_AGES', 'TEEN', 'MATURE', 'ADULT'], help='Minimum age rating for content')
    parser.add_argument('--max-input-length', type=int, default=512, help='Maximum input length')
    parser.add_argument('--max-output-length', type=int, default=100, help='Maximum output length')
    parser.add_argument('--content-filters', type=str, nargs='+', default=['bad_word', 'inappropriate', 'explicit'], help='List of content filters to apply')
    parser.add_argument('--block-sensitive-topics', action='store_true', help='Enable sensitive topic blocking')
    parser.add_argument('--require-content-warning', action='store_true', help='Require content warnings for mature content')
