...
# Add safety_features to Python path
sys.path.append(str(Path(__file__).parent.parent.parent))

from safety_features.src.safety_checks import SafetyConfig, AgeRating
...
def load_training_data(data_dir=None):
    ...
    # Preprocess data: filter out empty lines
